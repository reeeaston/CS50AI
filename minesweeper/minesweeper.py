...
class Sentence():
    ...
    def known_mines(self):
        ...
        """
        # When count is same as number of cells, they're all mines
    ...
    def mark_mine(self, cell):
        ...
        if cell in self.cells:
            # If it is, remove the cell from the sentence
            self.cells.remove(cell)
            # Since this cell is a mine, there's one less mine in the sentence
            # by removing it
            self.count -= 1
    ...
    def mark_safe(self, cell):
        ...
        # Check if cell is in the sentence
        if cell in self.cells:
            # If it is, remove it from the sentence
            self.cells.remove(cell)
            # Since it's not a mine, the amount of mines in the sentence remains
            # the same
...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        self.mark_safe(cell)
        # For any sentence that has the cell in it, mark it as safe
        for sentence in self.knowledge:
    ...
    def make_safe_move(self):
        ...
        """
        # If a cell is safe but hasn't been moved, move it
